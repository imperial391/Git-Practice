...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-disabled="false">producto</a>
    ...
    <!--Esata parte esta bien-->
    <div class="row flex-lg-row-reverse align-items-center g-5 m-4"> 
        <div class="col-10 col-sm-8 col-lg-6"> 
            <img src="img/6288505.webp" class="d-block mx-lg-auto img-fluid rounded-5" alt="Bootstrap Themes" width="700" height="500" loading="lazy"> 
        </div> 
        <div class="col-lg-6"> 
